...
import com.lowes.api.repo.UserRepository;
...
@RestController
public class CamelCassandraReactive1Application {
	@Autowired
	...
	public static void main(String[] args) {
		SpringApplication.run(CamelCassandraReactive1Application.class, args);
	}
}